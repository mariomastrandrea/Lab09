...
public class DFSReachableCountries implements ReachableCountriesStrategy
{
	...
	public Collection<Country> computeReachableCountriesFrom(Country country)
	{
		...
		DepthFirstIterator<Country, DefaultEdge> iterator =
										new DepthFirstIterator<>(this.graph, country);
